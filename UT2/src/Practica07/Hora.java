...
public class Hora {
	...
	String relojam_pm (int hora,int minutos,int segundos) {
		...
		horas=hora>23?00:horas;
		this.minutos=minutos;
		this.segundos=segundos;
		return horas<12&&horas>=0?"La hora es:"+horas+":"+this.minutos+":"+this.segundos+"am":"La hora es:"+horas+":"+this.minutos+":"+this.segundos+"pm";
	}
	...
	String segundos_mediodia (int horas_mediodia,int minutos_mediodia,int segundos_mediodia) {
		...
		return segundos>0?"La hora introducida es posterior a mediodia: "+segundos+"segundos":"Dato introducido incorrecto";
	}	
		}
